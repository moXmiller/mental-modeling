...
def write_statistics_mental(model_name, problem_type, num_bootstrap=100):
    ...
    for depth in range(min_depth, max_depth):
        # statistics = {}
        # outs_path = f"data/mm/mental/{model_name}/outputs/outs_{problem_type}_{depth}_updated.csv"
...
#     problem_types = ["add", "trans", "part", "nonlinear"]
#     model_names = ["qwen2.5-7b"]#, "llama3-70b", "mixtral-8x7b"]
#     for model_name in model_names:
#         for problem_type in problem_types:
#             write_statistics_csv(model_name, problem_type, random_context=False)

if __name__ == "__main__":
    # manipulate_mental_outs("llama3-8b","trans")
    # write_statistics_mental("llama3.2-11b","trans")

    # write_statistics_vlm("llama3.2-11b", "trans", True, False)
    # write_statistics_vlm("llama3.2-90b", "trans", True, False, True)
    # write_statistics_vlm("llama3.2-11b", "trans", True, False, True, True)
    # write_statistics_vlm("llama3.2-11b", "trans", True, False, True, False)
    # plot_statistics("llama3.2-11b", "trans", True, False, True, True, False)
    # write_statistics_from_logical_forms("llama3.2-90b", text = False, num_bootstrap=100)
    # manipulate_cot_outs("llama3.3-70b")
    write_statistics_cot("r1-distill-qwen")

    # plot_statistics("llama3.2-11b", "trans", True, False, True, True)
    # write_comparison_statistics("llama3.2-90b", new_prompt=True)
    # write_comparison_statistics("llama3.2-11b", new_prompt=True)
    # plot_statistics("llama3-8b", "trans")#, True)
    # write_statistics_vlm("llama3.2-11b","trans", False, True)
    # write_statistics_vlm("llama3.2-90b","trans", False, True)
    # plot_statistics("llama3.2-11b", "trans", True, True)#, True)
    # plot_statistics("llama3.2-90b", "trans", True, True)
    # plot_statistics("llama3.2-11b", "trans", True)
    # plot_statistics("llama3.2-11b", "trans", True, False, True)
    # write_comparison_statistics("llama3.2-90b")
    # retrieve_superior_outputs("llama3.2-11b")