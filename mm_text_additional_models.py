...
def run_mllama_additional_models(tensor_parallel_size: int, model_path, model_name = None): #, model_name = "unsloth/Llama-3.2-11B-Vision-Instruct"):
    if model_name == "llama3.3-70b": model = "meta-llama/Llama-3.3-70B-Instruct"
    elif model_name == "r1-distill-qwen": model = "deepseek-ai/DeepSeek-R1-Distill-Qwen-32B"
    if model_path == "/cluster/scratch/millerm/.cache/huggingface/hub/": llm = LLM( # if model != None:
        model=model,
        max_model_len=4096,
        max_num_seqs=16,
        # enforce_eager=True,
...
model_map_path = {
    "llama3.1-8b": "/cluster/work/sachan/shridhar/models/llama31-8B-instruct/",
    "llama3.1-70b": "/cluster/work/sachan/shridhar/models/llama31-70b-instruct/",
    "llama3.2-1b": "/cluster/work/sachan/shridhar/models/llama32-1B-instruct/",
    "llama3.2-3b": "/cluster/work/sachan/shridhar/models/llama-32-3B-it/",
    "llama3.3-70b": "/cluster/scratch/millerm/.cache/huggingface/hub/",
    "r1-distill-llama": "/cluster/work/sachan/shridhar/models/deepseek-R1-llama-70B/",
    "r1-distill-qwen": "/cluster/scratch/millerm/.cache/huggingface/hub/"
}
...
def main(args, template_file = "data/temp_no_plural.csv"):
    ...
    stop_words = [] # ["I hope it is correct."] # [f"$\\boxed{{{integer}}}$" for integer in range(-200, 201)] + ["I hope it is correct.",".0.0.0.0.0.0"] # ["**Answer:**", "####", "###", "*Answer:*","*Answer*","I hope it is correct."]
